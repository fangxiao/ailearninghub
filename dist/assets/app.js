(function(){"use strict";const i={data:window.SITE_DATA||{categories:[],articles:[],stats:{}},activeCategory:"all",searchQuery:"",difficultyFilter:"all",viewMode:"roadmap",roadmapTrack:"tech",theme:localStorage.getItem("ai_hub_theme")||"dark",readerTheme:localStorage.getItem("ai_hub_reader_theme")||"default",readerFontSize:parseInt(localStorage.getItem("ai_hub_reader_fontsize")||"16",10),currentArticle:null,history:JSON.parse(localStorage.getItem("ai_hub_history")||"[]")},t={app:document.getElementById("app"),themeToggle:document.getElementById("theme-toggle"),themeIcon:document.getElementById("theme-icon"),searchInput:document.getElementById("search-input"),searchClear:document.getElementById("search-clear"),categoryTabs:document.getElementById("category-tabs"),categorySelect:document.getElementById("category-select"),viewButtons:document.querySelectorAll("[data-view]"),mainContent:document.getElementById("main-content"),readerModal:document.getElementById("reader-modal"),readerIframeContainer:document.getElementById("reader-iframe-container"),readerMarkdownContainer:document.getElementById("reader-markdown-container"),readerFrame:document.getElementById("reader-frame"),markdownContent:document.getElementById("markdown-content"),readerTitle:document.getElementById("reader-title"),readerCategory:document.getElementById("reader-category"),readerTocList:document.getElementById("reader-toc-list"),readerTocDrawer:document.getElementById("reader-toc-drawer"),wechatModal:document.getElementById("wechat-modal"),btnPrevArticle:document.getElementById("btn-prev-article"),btnNextArticle:document.getElementById("btn-next-article"),btnOpenExternal:document.getElementById("btn-open-external"),btnCloseReader:document.getElementById("btn-close-reader"),btnToggleToc:document.getElementById("btn-toggle-toc"),toast:document.getElementById("toast")};function w(){y(i.theme),H(),R(),N(),c();const e=new URLSearchParams(window.location.search),a=e.get("category"),s=e.get("article"),r=e.get("view");if(r&&["grid","list","tree","shelf","roadmap","my-space"].includes(r)&&(i.viewMode=r,x()),a&&(a==="all"||i.data.categories.some(n=>n.id===a))&&(i.activeCategory=a,g()),s){const n=i.data.articles.find(d=>d.id===s||d.path===s);n&&u(n)}}function y(e){i.theme=e,localStorage.setItem("ai_hub_theme",e),e==="light"?(document.documentElement.classList.add("light-theme"),document.documentElement.classList.remove("dark"),t.themeIcon&&(t.themeIcon.innerHTML="\u2600\uFE0F")):(document.documentElement.classList.remove("light-theme"),document.documentElement.classList.add("dark"),t.themeIcon&&(t.themeIcon.innerHTML="\u{1F319}"))}function $(){y(i.theme==="dark"?"light":"dark")}let k;function v(e,a="\u2728"){t.toast&&(t.toast.innerHTML=`<span class="text-xl">${a}</span><span>${e}</span>`,t.toast.classList.remove("opacity-0","translate-y-4","pointer-events-none"),t.toast.classList.add("opacity-100","translate-y-0"),clearTimeout(k),k=setTimeout(()=>{t.toast.classList.add("opacity-0","translate-y-4","pointer-events-none"),t.toast.classList.remove("opacity-100","translate-y-0")},2400))}function q(){t.statsArticles&&(t.statsArticles.textContent=i.data.articles.length),t.statsCategories&&(t.statsCategories.textContent=i.data.categories.length),t.statsEbooks&&(t.statsEbooks.textContent=i.data.categories.find(e=>e.id==="ebooks")?.count||7)}function H(){if(!t.categoryTabs)return;const e=i.data.categories;let a=`
    ...
    `;e.forEach(s=>{const r=i.activeCategory===s.id;a+=`
      ...
      `;const d=document.getElementById("btn-clear-search-res");d&&d.addEventListener("click",()=>{i.searchQuery="",t.searchInput.value="",c()});return}let s="";a.forEach(r=>{const n=i.data.articles.filter(o=>o.categoryId===r.id);if(n.length===0)return;const d=n[0];s+=`
          ...
          <div class="p-6 md:p-8 rounded-3xl glass border border-white/10 mb-6 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
              ...
              <div class="flex items-center gap-2.5 shrink-0">
                ...
                ${d?`
                  <button onclick="window.AI_HUB.openReaderById('${d.id}')" class="btn-read px-4 py-2 text-xs font-bold rounded-xl shadow-lg flex items-center gap-1.5">
                    <span>\u26A1 \u4ECE\u7B2C 1 \u7AE0\u5F00\u59CB</span>
                  </button>
                `:""}
              </div>
    ...
    `}function C(e){const a=i.data.categories.find(r=>r.id===e.categoryId)||{};let s="bg-blue-500/20 text-blue-400 border-blue-500/30";return e.format==="pdf"&&(s="bg-rose-500/20 text-rose-400 border-rose-500/30"),e.format==="md"&&(s="bg-amber-500/20 text-amber-400 border-amber-500/30"),`
      <div class="article-card rounded-2xl glass border border-white/10 p-6 flex flex-col justify-between relative group">
        <div>
          ...
          <p class="text-xs text-slate-400 mt-2.5 line-clamp-3 leading-relaxed">
            ${m(e.summary||"\u70B9\u51FB\u8FDB\u5165\u9605\u8BFB\u5168\u7BC7\u8BE6\u7EC6\u56FE\u6587\u5185\u5BB9\u4E0E\u6280\u672F\u62C6\u89E3\u3002")}
          </p>
        </div>
    ...
    `}function D(){const e=I();if(e.length===0){t.mainContent.innerHTML=L();return}t.mainContent.innerHTML=`
        ...
        <div class="block sm:hidden divide-y divide-white/5">
          ${e.map(a=>{const s=i.data.categories.find(r=>r.id===a.categoryId)||{};return`
              <div class="p-4 hover:bg-white/5 transition flex flex-col gap-2.5">
                ...
                ${a.subtitle?`<div class="text-xs text-slate-400 line-clamp-1">${m(a.subtitle)}</div>`:""}
              ...
              ${e.map(a=>{const s=i.data.categories.find(r=>r.id===a.categoryId)||{};return`
                  <tr class="hover:bg-white/5 transition">
                    ...
                    <td class="px-6 py-4">
                      ...
                      ${a.subtitle?`<div class="text-xs text-slate-400 mt-0.5 line-clamp-1">${m(a.subtitle)}</div>`:""}
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
    ...
    `}function P(){const e=i.data.categories;t.mainContent.innerHTML=`
    ...
    `}function A(){const e=i.roadmapTrack==="tech",r=e?[{level:"Level 1",title:"\u{1F331} \u57FA\u7840\u901A\u8BC6\u4E0E\u5927\u6A21\u578B\u5E95\u5C42\u539F\u7406",desc:"\u6DF1\u5165\u638C\u63E1\u5927\u6A21\u578B\u6838\u5FC3\u67B6\u6784\u3001\u6CE8\u610F\u529B\u673A\u5236 (Self-Attention)\u3001RoPE \u4E0E\u4F4D\u7F6E\u7F16\u7801\u6570\u5B66\u539F\u7406\u4E0E\u524D\u6CBF\u8109\u7EDC",categories:["ai-science","ai-news","bigmodel","ai-safety"],skills:["Transformer \u67B6\u6784","\u6CE8\u610F\u529B\u673A\u5236\u8BA1\u7B97","Token & \u5D4C\u5165\u5411\u91CF","\u6A21\u578B\u5B89\u5168\u4E0E\u4F26\u7406"]},{level:"Level 2",title:"\u26A1 Agent \u6838\u5FC3\u67B6\u6784\u3001\u624B\u5199\u6846\u67B6\u4E0E\u601D\u8003\u5FAA\u73AF",desc:"\u4ECE\u96F6\u624B\u5199\u8F7B\u91CF\u7EA7 Agent \u601D\u8003\u5FAA\u73AF\uFF0C\u6DF1\u5165 OpenClaw \u667A\u80FD\u4F53\u7CFB\u7EDF\uFF0C\u638C\u63E1\u6709\u9650\u72B6\u6001\u673A\u3001\u610F\u56FE\u611F\u77E5\u4E0E\u8BB0\u5FC6\u7CFB\u7EDF",categories:["myagent","agent-core","openclaw"],skills:["ReAct \u601D\u8003\u5FAA\u73AF","\u77ED/\u957F\u671F\u8BB0\u5FC6\u7CFB\u7EDF","\u5DE5\u5177\u8C03\u7528\u534F\u8BAE","OpenClaw \u667A\u80FD\u4F53"]},{level:"Level 3",title:"\u{1F6E0}\uFE0F \u73B0\u4EE3 AI \u5DE5\u5177\u94FE\u4E0E AI Coding \u5168\u6808\u8FDB\u9636",desc:"\u73A9\u8F6C Claude Code \u5168\u5BB6\u6876\u3001AI Coding 33\u7BC7\u5168\u4F53\u7CFB\u3001MCP Server \u534F\u8BAE\u5F00\u53D1\u3001TDD \u4E0E\u540E\u7AEF\u670D\u52A1\u96C6\u6210",categories:["aitools","ai-coding"],skills:["Claude Code \u5168\u5BB6\u6876","MCP \u534F\u8BAE\u5F00\u53D1","AI \u8F85\u52A9\u67B6\u6784\u8BBE\u8BA1","\u6D4B\u8BD5\u9A71\u52A8\u5F00\u53D1 TDD"]},{level:"Level 4",title:"\u{1F4BC} \u4F01\u4E1A\u7EA7\u5DE5\u7A0B\u843D\u5730\u4E0E\u79C1\u6709\u77E5\u8BC6\u5E93 (RAG)",desc:"\u843D\u5730\u4F01\u4E1A\u667A\u80FD\u5BA2\u670D\u5168\u95ED\u73AF\u3001\u6784\u5EFA\u79C1\u6709\u672C\u5730\u5927\u6A21\u578B\u77E5\u8BC6\u5E93 (Ollama + \u5411\u91CF\u5E93)\u3001\u6253\u9020\u5782\u76F4\u9886\u57DF Agent \u7CFB\u7EDF",categories:["customer-service","customer-service-harness","local-rag","english-agent","quant-agent"],skills:["\u4F01\u4E1A\u5FAE\u4FE1\u667A\u80FD\u5BA2\u670D","\u672C\u5730\u79C1\u6709 RAG","\u5411\u91CF\u68C0\u7D22\u4E0E\u91CD\u6392","\u5782\u76F4 Agent \u843D\u5730"]}]:[{level:"Level 1",title:"\u{1F3AF} \u4E1A\u52A1\u8BA4\u77E5\u4E0E\u9AD8\u9636\u63D0\u793A\u5DE5\u7A0B (Prompt \u8D4B\u80FD\u4E1A\u52A1)",desc:"\u628A\u4E1A\u52A1\u89C4\u5219\u8F6C\u5316\u4E3A\u5927\u6A21\u578B\u80FD\u7CBE\u51C6\u6267\u884C\u7684\u9AD8\u9636 Prompt\uFF0C\u638C\u63E1\u7ED3\u6784\u5316\u8F93\u51FA\u3001\u4E1A\u52A1\u8FB9\u754C\u7EA6\u675F\u4E0E\u975E\u7ED3\u6784\u5316\u6570\u636E\u6E05\u6D17",categories:["aitools","ai-news"],skills:["\u7ED3\u6784\u5316 Prompt \u6A21\u677F","\u4E1A\u52A1\u89C4\u5219\u4E0E\u8FB9\u754C\u7EA6\u675F","\u975E\u7ED3\u6784\u5316\u6570\u636E\u521D\u7B5B","\u884C\u4E1A\u7814\u62A5\u79D2\u7EA7\u63D0\u70BC"]},{level:"Level 2",title:"\u{1F4A1} AI \u4EA7\u54C1\u8BBE\u8BA1\u4E0E\u4E1A\u52A1\u6D41\u91CD\u6784 (AI PRD \u4E0E\u573A\u666F\u6316\u6398)",desc:"\u638C\u63E1 AI \u539F\u751F\u4EA7\u54C1\u9700\u6C42\u5B9A\u4E49\uFF08AI PRD \u89C4\u8303\uFF09\u3001\u4EBA\u673A\u534F\u540C\u4EA4\u4E92\u6A21\u5F0F\u8BBE\u8BA1\u3001\u4E1A\u52A1\u6F0F\u6597\u5168\u94FE\u8DEF\u91CD\u5851\u4E0E\u5185\u5BB9\u6279\u91CF\u751F\u4EA7\u7BA1\u7EBF",categories:["aitools","ai-coding","english-agent"],skills:["AI PRD \u7ED3\u6784\u5316\u64B0\u5199","Copilot vs Agent \u6A21\u5F0F","\u5E7B\u89C9\u63A7\u5236\u4E0E\u8BC4\u6D4B (Eval)","\u4E1A\u52A1\u6F0F\u6597\u5168\u94FE\u8DEF\u91CD\u6784"]},{level:"Level 3",title:"\u{1F916} \u96F6\u4EE3\u7801\u642D\u5EFA\u4E1A\u52A1\u667A\u80FD\u4F53 (Dify/\u6263\u5B50\u5B9E\u64CD\u843D\u5730)",desc:"\u65E0\u9700\u7F16\u5199\u4E00\u884C\u4EE3\u7801\uFF0C\u901A\u8FC7 Dify / \u6263\u5B50 / FastGPT \u53EF\u89C6\u5316\u642D\u5EFA\u4F01\u4E1A\u4E13\u5C5E\u77E5\u8BC6\u95EE\u7B54\u52A9\u624B\u3001\u4E1A\u52A1\u81EA\u52A8\u5316\u5DE5\u4F5C\u6D41\u4E0E\u4F01\u5FAE/\u98DE\u4E66\u673A\u5668\u4EBA",categories:["customer-service","local-rag","openclaw"],skills:["\u4F01\u4E1A\u79C1\u6709\u77E5\u8BC6\u95EE\u7B54\u5E93","\u81EA\u52A8\u5316\u5DE5\u4F5C\u6D41 Workflow","\u9500\u552E\u4E0E\u5BA2\u670D\u667A\u80FD\u52A9\u624B","\u4F01\u5FAE/\u98DE\u4E66\u673A\u5668\u4EBA\u63A5\u5165"]},{level:"Level 4",title:"\u{1F4C8} \u4E1A\u52A1 ROI \u8BC4\u4F30\u4E0E\u5546\u4E1A\u5316\u95ED\u73AF (\u51B3\u7B56\u4E0E\u5546\u4E1A\u843D\u5730)",desc:"\u638C\u63E1 AI \u9879\u76EE\u6295\u5165\u4EA7\u51FA\u6BD4\uFF08ROI\uFF09\u6D4B\u7B97\u3001\u81EA\u7814 vs SaaS \u91C7\u8D2D\u51B3\u7B56\u3001\u4E00\u4EBA\u516C\u53F8\uFF08Solopreneur\uFF09\u95ED\u73AF\u4E0E\u5782\u76F4\u884C\u4E1A\u771F\u5B9E\u6848\u4F8B",categories:["customer-service-harness","quant-agent","ai-safety"],skills:["\u81EA\u7814 vs SaaS \u9009\u578B ROI","\u4E00\u4EBA\u516C\u53F8 AI \u534F\u540C\u95ED\u73AF","\u5782\u76F4\u884C\u4E1A\u843D\u5730\u6848\u4F8B\u62C6\u89E3","\u4E1A\u52A1\u56E2\u961F AI \u843D\u5730 SOP"]}];t.mainContent.innerHTML=`
      <div class="max-w-4xl mx-auto animate-fade-in px-1 sm:px-0">
        ...
        <div class="text-center mb-8 sm:mb-10">
          ...
          <p class="text-slate-300 text-xs sm:text-sm mt-2 max-w-xl mx-auto leading-relaxed">
            ${e?"\u6309\u7167 4 \u4E2A\u5DE5\u7A0B\u8FDB\u9636\u9636\u6BB5\u5FAA\u5E8F\u6E10\u8FDB\u7814\u8BFB\uFF0C\u638C\u63E1\u4ECE\u5927\u6A21\u578B\u539F\u7406\u5230 Agent \u843D\u5730\u3001AI \u7F16\u7A0B\u5B9E\u6218\u4E0E\u5168\u6808\u5DE5\u7A0B\u4F53\u7CFB\u3002":"\u4E13\u4E3A\u4EA7\u54C1\u7ECF\u7406\u3001\u4E1A\u52A1\u4E13\u5BB6\u4E0E\u8FD0\u8425\u6253\u9020\uFF1A\u4ECE\u9AD8\u9636\u63D0\u793A\u5DE5\u7A0B\u5230 AI \u539F\u751F\u4EA7\u54C1\u8BBE\u8BA1\u3001\u96F6\u4EE3\u7801\u642D\u5EFA\u4F01\u4E1A\u667A\u80FD\u4F53\u4E0E\u5546\u4E1A\u95ED\u73AF\u3002"}
          </p>
        </div>

        <div class="space-y-6 sm:space-y-8">
          ${r.map(n=>{const d=i.data.articles.filter(o=>n.categories.includes(o.categoryId));return`
              <div class="roadmap-step">
                ...
                <div class="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl glass border border-white/10">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 mt-3 sm:mt-4">
                    ${n.categories.map(o=>{const l=i.data.categories.find(f=>f.id===o);if(!l)return"";const h=i.data.articles.filter(f=>f.categoryId===o).length;return`
...
`).forEach(o=>{(o.startsWith("## ")||o.startsWith("### "))&&n.push(o.replace(/^#+\s*/,"").trim())}),e.toc=n.slice(0,15),M(e)}).catch(s=>{t.markdownContent&&(t.markdownContent.innerHTML=`<div class="text-rose-400 p-6">\u52A0\u8F7D Markdown \u6587\u4EF6\u5931\u8D25\uFF1A${s.message}</div>`)})):(t.readerMarkdownContainer&&t.readerMarkdownContainer.classList.add("hidden"),t.readerIframeContainer&&t.readerIframeContainer.classList.remove("hidden"),t.readerFrame&&(t.readerFrame.src=e.path,t.readerFrame.onload=function(){try{const s=t.readerFrame.contentDocument||t.readerFrame.contentWindow.document;if(!s)return;const r=s.createElement("style");r.textContent=`
    ...
    `).join("")}function W(e){if(i.currentArticle&&i.currentArticle.format==="md"&&t.markdownContent){const a=t.markdownContent.querySelectorAll("h1, h2, h3, h4");for(const s of a)if(s.textContent.trim().includes(e)||e.includes(s.textContent.trim())){s.scrollIntoView({behavior:"smooth",block:"start"});break}}}function b(e){if(!i.currentArticle)return;const a=i.data.articles.filter(r=>r.categoryId===i.currentArticle.categoryId),s=a.findIndex(r=>r.id===i.currentArticle.id);e==="prev"&&s>0?u(a[s-1]):e==="next"&&s<a.length-1&&u(a[s+1])}function O(){t.wechatModal&&(t.wechatModal.classList.remove("hidden"),document.body.style.overflow="hidden")}function E(){t.wechatModal&&(t.wechatModal.classList.add("hidden"),document.body.style.overflow="")}function Q(){const e="\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08";navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(e).then(()=>{v("\u5DF2\u590D\u5236\u516C\u4F17\u53F7\u540D\u79F0\uFF1A\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08","\u{1F4CB}")}).catch(()=>{B(e)}):B(e)}function B(e){const a=document.createElement("input");a.value=e,document.body.appendChild(a),a.select();try{document.execCommand("copy"),v("\u5DF2\u590D\u5236\u516C\u4F17\u53F7\u540D\u79F0\uFF1A\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08","\u{1F4CB}")}catch{v("\u516C\u4F17\u53F7\u540D\u79F0\uFF1A\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08","\u{1F4AC}")}document.body.removeChild(a)}function N(){t.themeToggle&&t.themeToggle.addEventListener("click",$),t.searchInput&&t.searchInput.addEventListener("input",e=>{i.searchQuery=e.target.value.trim(),t.searchClear&&t.searchClear.classList.toggle("hidden",!i.searchQuery),c()}),t.searchClear&&t.searchClear.addEventListener("click",()=>{i.searchQuery="",t.searchInput.value="",t.searchClear.classList.add("hidden"),c()}),t.categoryTabs&&t.categoryTabs.addEventListener("click",e=>{const a=e.target.closest("[data-category]");a&&(i.activeCategory=a.dataset.category,i.activeCategory!=="all"&&i.viewMode==="roadmap"&&(i.viewMode="grid",x()),g(),c())}),t.categorySelect&&t.categorySelect.addEventListener("change",e=>{i.activeCategory=e.target.value,i.activeCategory!=="all"&&i.viewMode==="roadmap"&&(i.viewMode="grid",x()),g(),c()}),t.viewButtons.forEach(e=>{e.addEventListener("click",()=>{i.viewMode=e.dataset.view,x(),c()})}),t.btnCloseReader&&t.btnCloseReader.addEventListener("click",T),t.btnPrevArticle&&t.btnPrevArticle.addEventListener("click",()=>b("prev")),t.btnNextArticle&&t.btnNextArticle.addEventListener("click",()=>b("next")),t.btnToggleToc&&t.btnToggleToc.addEventListener("click",()=>{t.readerTocDrawer&&t.readerTocDrawer.classList.toggle("hidden")}),document.addEventListener("keydown",e=>{(e.metaKey||e.ctrlKey)&&e.key==="k"&&(e.preventDefault(),t.searchInput?.focus()),e.key==="Escape"&&(i.currentArticle&&T(),t.wechatModal&&!t.wechatModal.classList.contains("hidden")&&E()),i.currentArticle&&!e.target.matches("input, textarea")&&(e.key==="ArrowLeft"&&b("prev"),e.key==="ArrowRight"&&b("next")),(e.key==="t"||e.key==="T")&&!e.target.matches("input, textarea")&&!i.currentArticle&&$()})}window.AI_HUB={openReaderById:function(e){const a=i.data.articles.find(s=>s.id===e);a&&u(a)},switchCategory:function(e){i.activeCategory=e,i.viewMode="grid",g(),x(),c(),window.scrollTo({top:400,behavior:"smooth"})},openWeChatModal:O,closeWeChatModal:E,copyWeChatName:Q,scrollToHeading:W,resetFilters:function(){i.activeCategory="all",i.searchQuery="",t.searchInput&&(t.searchInput.value=""),g(),c()},switchView:function(e){i.viewMode=e,x(),c()},switchRoadmapTrack:function(e){i.roadmapTrack=e,A()}},document.readyState==="loading"?document.addEventListener("DOMContentLoaded",w):w()})();