(function(){"use strict";const a={data:window.SITE_DATA||{categories:[],articles:[],stats:{}},activeCategory:"all",searchQuery:"",difficultyFilter:"all",viewMode:"roadmap",roadmapTrack:"tech",theme:localStorage.getItem("ai_hub_theme")||"dark",readerTheme:localStorage.getItem("ai_hub_reader_theme")||"default",readerFontSize:parseInt(localStorage.getItem("ai_hub_reader_fontsize")||"16",10),currentArticle:null,history:JSON.parse(localStorage.getItem("ai_hub_history")||"[]")},s={app:document.getElementById("app"),themeToggle:document.getElementById("theme-toggle"),themeIcon:document.getElementById("theme-icon"),searchInput:document.getElementById("search-input"),searchClear:document.getElementById("search-clear"),categoryTabs:document.getElementById("category-tabs"),categorySelect:document.getElementById("category-select"),viewButtons:document.querySelectorAll("[data-view]"),mainContent:document.getElementById("main-content"),readerModal:document.getElementById("reader-modal"),readerIframeContainer:document.getElementById("reader-iframe-container"),readerMarkdownContainer:document.getElementById("reader-markdown-container"),readerFrame:document.getElementById("reader-frame"),markdownContent:document.getElementById("markdown-content"),readerTitle:document.getElementById("reader-title"),readerCategory:document.getElementById("reader-category"),readerTocList:document.getElementById("reader-toc-list"),readerTocDrawer:document.getElementById("reader-toc-drawer"),wechatModal:document.getElementById("wechat-modal"),btnPrevArticle:document.getElementById("btn-prev-article"),btnNextArticle:document.getElementById("btn-next-article"),btnOpenExternal:document.getElementById("btn-open-external"),btnCloseReader:document.getElementById("btn-close-reader"),btnToggleToc:document.getElementById("btn-toggle-toc"),toast:document.getElementById("toast")};function $(){k(a.theme),j(),R(),Q(),p(),H();const e=new URLSearchParams(window.location.search),t=e.get("category"),i=e.get("article"),n=e.get("view");if(n&&["grid","list","tree","shelf","roadmap","my-space","showcases","works"].includes(n)&&(a.viewMode=n==="works"?"showcases":n,a.viewMode=n,h()),t&&(t==="all"||a.data.categories.some(o=>o.id===t))&&(a.activeCategory=t,f()),i){const o=a.data.articles.find(d=>d.id===i||d.path===i);o&&u(o)}const r=()=>{const o=window.location.hash;o==="#showcases"||o==="#works"||o==="#tools"?(a.viewMode="showcases",h(),p()):o==="#roadmap"&&(a.viewMode="roadmap",h(),p())};window.addEventListener("hashchange",r),r()}function k(e){a.theme=e,localStorage.setItem("ai_hub_theme",e),e==="light"?(document.documentElement.classList.add("light-theme"),document.documentElement.classList.remove("dark"),s.themeIcon&&(s.themeIcon.innerHTML="\u2600\uFE0F")):(document.documentElement.classList.remove("light-theme"),document.documentElement.classList.add("dark"),s.themeIcon&&(s.themeIcon.innerHTML="\u{1F319}"))}function C(){k(a.theme==="dark"?"light":"dark")}let I;function b(e,t="\u2728"){s.toast&&(s.toast.innerHTML=`<span class="text-xl">${t}</span><span>${e}</span>`,s.toast.classList.remove("opacity-0","translate-y-4","pointer-events-none"),s.toast.classList.add("opacity-100","translate-y-0"),clearTimeout(I),I=setTimeout(()=>{s.toast.classList.add("opacity-0","translate-y-4","pointer-events-none"),s.toast.classList.remove("opacity-100","translate-y-0")},2400))}function K(){s.statsArticles&&(s.statsArticles.textContent=a.data.articles.length),s.statsCategories&&(s.statsCategories.textContent=a.data.categories.length),s.statsEbooks&&(s.statsEbooks.textContent=a.data.categories.find(e=>e.id==="ebooks")?.count||7)}function H(){const e=document.getElementById("visitor-id-num"),t=document.getElementById("visitor-total-num");if(!e&&!t)return;const i="ai_hub_visitor_seq_id";let n=localStorage.getItem(i);const r=!n,o=c=>Number(c).toLocaleString("en-US");n&&(n=parseInt(n,10),!isNaN(n)&&n>0&&e&&(e.textContent=o(n)));const d=r?"?action=hit":"?action=get",l=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?"https://api.ailearning.top/api/visitor"+d:"/api/visitor"+d;fetch(l).then(c=>c.ok?c.json():fetch("https://api.ailearning.top/api/visitor"+d).then(m=>m.json())).then(c=>{if(!c||typeof c.total>"u")return;const m=parseInt(c.total,10)||1;if(r){n=m;try{localStorage.setItem(i,String(n))}catch{}}e&&(e.textContent=o(n||m)),t&&(t.textContent=o(Math.max(m,n||m)))}).catch(()=>{e&&e.textContent==="..."&&(e.textContent="1"),t&&t.textContent==="..."&&(t.textContent="1")})}function j(){if(!s.categoryTabs)return;const e=a.data.categories;let t=`
    ...
    `;e.forEach(i=>{const n=a.activeCategory===i.id;t+=`
      ...
      `}),s.mainContent.innerHTML=i}function U(e,t){return`
    ...
    `}function _(e){const t=a.data.categories.find(n=>n.id===e.categoryId)||{};let i="bg-blue-500/20 text-blue-400 border-blue-500/30";return e.format==="pdf"&&(i="bg-rose-500/20 text-rose-400 border-rose-500/30"),e.format==="md"&&(i="bg-amber-500/20 text-amber-400 border-amber-500/30"),`
    ...
    `}function D(){const e=A();if(e.length===0){s.mainContent.innerHTML=T();return}s.mainContent.innerHTML=`
        ...
        <div class="block sm:hidden divide-y divide-white/5">
          ${e.map(t=>{const i=a.data.categories.find(n=>n.id===t.categoryId)||{};return`
              <div class="p-4 hover:bg-white/5 transition flex flex-col gap-2.5">
                ...
                ${t.subtitle?`<div class="text-xs text-slate-400 line-clamp-1">${g(t.subtitle)}</div>`:""}
              ...
              ${e.map(t=>{const i=a.data.categories.find(n=>n.id===t.categoryId)||{};return`
                  <tr class="hover:bg-white/5 transition">
                    ...
                    <td class="px-6 py-4">
                      ...
                      ${t.subtitle?`<div class="text-xs text-slate-400 mt-0.5 line-clamp-1">${g(t.subtitle)}</div>`:""}
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
    ...
    `}function O(){const e=a.data.categories;s.mainContent.innerHTML=`
                ...
                <div class="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl glass border border-white/10">
                  ...
                  ${e?`
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 mt-3 sm:mt-4">
                      ${r.categories.map(d=>{const l=a.data.categories.find(m=>m.id===d);if(!l)return"";const c=a.data.articles.filter(m=>m.categoryId===d).length;return`
                          <div onclick="window.AI_HUB.switchCategory('${l.id}')" class="p-3 sm:p-3.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-indigo-500/30 transition flex items-center justify-between cursor-pointer group">
                            ...
                            <span class="text-[11px] sm:text-xs bg-white/10 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full text-slate-300 group-hover:bg-indigo-600 group-hover:text-white transition">${c} \u7BC7</span>
                          </div>
                        `}).join("")}
                    </div>
                  `:`
                    ...
                    <div class="space-y-3 mt-3 sm:mt-4">
                      <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                        ${(r.curatedArticles||[]).map(d=>{const l=a.data.articles.find(c=>c.id===d.id);return l?`
...
`).forEach(d=>{(d.startsWith("## ")||d.startsWith("### "))&&r.push(d.replace(/^#+\s*/,"").trim())}),e.toc=r.slice(0,15),B(e)}).catch(i=>{s.markdownContent&&(s.markdownContent.innerHTML=`<div class="text-rose-400 p-6">\u52A0\u8F7D Markdown \u6587\u4EF6\u5931\u8D25\uFF1A${i.message}</div>`)})):(s.readerMarkdownContainer&&s.readerMarkdownContainer.classList.add("hidden"),s.readerIframeContainer&&s.readerIframeContainer.classList.remove("hidden"),s.readerFrame&&(s.readerFrame.src=e.path,s.readerFrame.onload=function(){try{const i=s.readerFrame.contentDocument||s.readerFrame.contentWindow.document;if(!i)return;const n=i.createElement("style");n.textContent=`
    ...
    `).join("")}function V(e){if(a.currentArticle&&a.currentArticle.format==="md"&&s.markdownContent){const t=s.markdownContent.querySelectorAll("h1, h2, h3, h4");for(const i of t)if(i.textContent.trim().includes(e)||e.includes(i.textContent.trim())){i.scrollIntoView({behavior:"smooth",block:"start"});break}}}function v(e){if(!a.currentArticle)return;const t=a.data.articles.filter(n=>n.categoryId===a.currentArticle.categoryId),i=t.findIndex(n=>n.id===a.currentArticle.id);e==="prev"&&i>0?u(t[i-1]):e==="next"&&i<t.length-1&&u(t[i+1])}function E(){s.wechatModal&&(s.wechatModal.classList.remove("hidden"),document.body.style.overflow="hidden")}function S(){s.wechatModal&&(s.wechatModal.classList.add("hidden"),document.body.style.overflow="")}function W(){const e="\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08";navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(e).then(()=>{b("\u5DF2\u590D\u5236\u516C\u4F17\u53F7\u540D\u79F0\uFF1A\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08","\u{1F4CB}")}).catch(()=>{w(e)}):w(e)}function Y(e){navigator.clipboard&&window.isSecureContext?navigator.clipboard.writeText(e).then(()=>{b(`\u5DF2\u590D\u5236\u53E3\u4EE4\u3010${e}\u3011\uFF0C\u8BF7\u5728\u5FAE\u4FE1\u516C\u4F17\u53F7\u540E\u53F0\u76F4\u63A5\u53D1\u9001\uFF01`,"\u{1F4CB}")}).catch(()=>{w(e)}):w(e),E()}function w(e){const t=document.createElement("input");t.value=e,document.body.appendChild(t),t.select();try{document.execCommand("copy"),b("\u5DF2\u590D\u5236\u516C\u4F17\u53F7\u540D\u79F0\uFF1A\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08","\u{1F4CB}")}catch{b("\u516C\u4F17\u53F7\u540D\u79F0\uFF1A\u5927\u524D\u7AEF\u5DE5\u7A0B\u5E08","\u{1F4AC}")}document.body.removeChild(t)}function Q(){s.themeToggle&&s.themeToggle.addEventListener("click",C),s.searchInput&&s.searchInput.addEventListener("input",t=>{a.searchQuery=t.target.value.trim(),s.searchClear&&s.searchClear.classList.toggle("hidden",!a.searchQuery),a.searchQuery&&a.viewMode!=="grid"&&a.viewMode!=="list"&&(a.viewMode="grid",h()),p()}),s.searchClear&&s.searchClear.addEventListener("click",()=>{a.searchQuery="",s.searchInput.value="",s.searchClear.classList.add("hidden"),s.searchInput.focus(),p()}),document.querySelectorAll(".hot-tag-btn").forEach(t=>{t.addEventListener("click",()=>{const i=t.dataset.keyword;i&&s.searchInput&&(s.searchInput.value=i,a.searchQuery=i,s.searchClear&&s.searchClear.classList.remove("hidden"),a.viewMode!=="grid"&&a.viewMode!=="list"&&(a.viewMode="grid",h()),p(),s.mainContent?.scrollIntoView({behavior:"smooth",block:"start"}))})});function e(){if(!s.mainContent)return;if(a.viewMode==="showcases"){window.scrollTo({top:0,behavior:"smooth"});return}const t=document.getElementById("category-nav-bar");if(t&&!t.classList.contains("hidden")){const i=t.getBoundingClientRect(),n=window.pageYOffset+i.top-65;window.scrollTo({top:Math.max(0,n),behavior:"smooth"})}else{const i=s.mainContent.getBoundingClientRect(),n=window.pageYOffset+i.top-70;window.scrollTo({top:Math.max(0,n),behavior:"smooth"})}}s.categoryTabs&&s.categoryTabs.addEventListener("click",t=>{const i=t.target.closest("[data-category]");i&&(a.activeCategory=i.dataset.category,a.activeCategory!=="all"&&a.viewMode==="roadmap"&&(a.viewMode="grid",h()),f(),p(),e())}),s.categorySelect&&s.categorySelect.addEventListener("change",t=>{a.activeCategory=t.target.value,a.activeCategory!=="all"&&a.viewMode==="roadmap"&&(a.viewMode="grid",h()),f(),p(),e()}),s.viewButtons.forEach(t=>{t.addEventListener("click",()=>{a.viewMode=t.dataset.view,h(),p(),e()})}),s.btnCloseReader&&s.btnCloseReader.addEventListener("click",M),s.btnPrevArticle&&s.btnPrevArticle.addEventListener("click",()=>v("prev")),s.btnNextArticle&&s.btnNextArticle.addEventListener("click",()=>v("next")),s.btnToggleToc&&s.btnToggleToc.addEventListener("click",()=>{s.readerTocDrawer&&s.readerTocDrawer.classList.toggle("hidden")}),document.addEventListener("keydown",t=>{(t.metaKey||t.ctrlKey)&&(t.key==="k"||t.key==="K")&&(t.preventDefault(),s.searchInput?.focus(),s.searchInput?.select()),t.key==="Escape"&&(a.currentArticle&&M(),s.wechatModal&&!s.wechatModal.classList.contains("hidden")&&S()),a.currentArticle&&!t.target.matches("input, textarea")&&(t.key==="ArrowLeft"&&v("prev"),t.key==="ArrowRight"&&v("next")),(t.key==="t"||t.key==="T")&&!t.target.matches("input, textarea")&&!a.currentArticle&&C()})}function q(){let t=`
      <div class="mb-10 animate-fade-in pt-4 sm:pt-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          ${(a.data.showcases||[]).map(z).join("")}
        </div>

      </div>
    `;s.mainContent.innerHTML=t}function z(e){const t=e.theme||"emerald",i=(e.features||[]).map(o=>`
    ...
    `}window.AI_HUB={openReaderById:function(e){const t=a.data.articles.find(i=>i.id===e);t&&u(t)},openReaderByPath:function(e){if(!e)return;const t=e.split("#")[0],i=a.data.articles.find(n=>n.path===t||n.path.endsWith(t)||t.endsWith(n.path));i&&u(i)},switchCategory:function(e){a.activeCategory=e,a.viewMode="grid",f(),h(),p(),scrollToMainContent()},openWeChatModal:E,closeWeChatModal:S,copyWeChatName:W,scrollToHeading:V,resetFilters:function(){a.activeCategory="all",a.searchQuery="",s.searchInput&&(s.searchInput.value=""),f(),p()},switchView:function(e){a.viewMode=e,h(),p(),scrollToMainContent()},switchRoadmapTrack:function(e){a.roadmapTrack=e,L()}},document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$):$()})();