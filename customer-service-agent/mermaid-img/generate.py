...
def generate_mermaid_image(mmd_code, output_file):
    encoded = base64.urlsafe_b64encode(
        zlib.compress(mmd_code.encode('utf-8'), 9)
    ).decode('ascii')
...
generate_mermaid_image(mmd1, f"{base_dir}/diagram1.png")
time.sleep(1)
generate_mermaid_image(mmd2, f"{base_dir}/diagram2.png")
time.sleep(1)
generate_mermaid_image(mmd3, f"{base_dir}/diagram3.png")
time.sleep(1)
generate_mermaid_image(mmd4, f"{base_dir}/diagram4.png")
print("Done!")
